...
![GitHub Repo stars](https://img.shields.io/github/stars/MR WHITE AND PARZIVAL/VCPlayerBot?color=blue&style=flat)
![GitHub issues](https://img.shields.io/github/issues/MR WHITE AND PARZIVAL/VCPlayerBot)
![GitHub pull requests](https://img.shields.io/github/issues-pr/MR WHITE AND PARZIVAL/VCPlayerBot)
![GitHub contributors](https://img.shields.io/github/contributors/MR WHITE AND PARZIVAL/VCPlayerBot?style=flat)
![GitHub forks](https://img.shields.io/github/forks/MR WHITE AND PARZIVAL/VCPlayerBot?style=flat)
...
4. `SESSION_STRING` : Generate From here [![GenerateStringName](https://img.shields.io/badge/repl.it-generateStringName-yellowgreen)](https://repl.it/@MR WHITE AND PARZIVAL/getStringName)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/MR WHITE AND PARZIVAL/VCPlayerBot)

## Deploy to Railway
<p><a href=https://github.com/MR WHITE AND PARZIVAL/VCPlayerBot/issues/7> <img src="https://img.shields.io/badge/Deploy%20To%20Railway-blueviolet?style=for-the-badge&logo=railway" width="200""/></a></p>

 
## Deploy to VPS

```sh
git clone https://github.com/MR WHITE AND PARZIVAL/VCPlayerBot
cd VCPlayerBot
